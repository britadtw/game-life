...
export default async function RewardsPage() {
  ...
  const pointRewards = rewards.filter(r => r.type === RewardType.POINT_THRESHOLD);
  const goalRewards = rewards.filter(r => r.type === RewardType.GOAL_COMPLETE);
      ...
      <div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_400px] gap-6">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 p-6 h-fit">
            ...
            <form action={createPointReward} className="space-y-4">
              <div>
